...
|-----|-------|--------|------|
| [0001](0001-use-postgres-over-mongo.md) | PostgreSQL over MongoDB for primary datastore | accepted | 2026-01-15 |
| [0002](0002-rest-over-grpc.md) | REST API over gRPC for external service boundary | accepted | 2026-01-20 |
| [0003](0003-hexagonal-architecture.md) | Adopt hexagonal architecture for service layer | accepted | 2026-02-01 |
```
