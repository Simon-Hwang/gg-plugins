...
- Project: `${XDG_DATA_HOME:-~/.local/share}/gg-homunculus/projects/<project-hash>/observations.jsonl`
- Global fallback: `${XDG_DATA_HOME:-~/.local/share}/gg-homunculus/observations.jsonl`
...
- Project: `${XDG_DATA_HOME:-~/.local/share}/gg-homunculus/projects/<project-hash>/instincts/personal/`
- Global: `${XDG_DATA_HOME:-~/.local/share}/gg-homunculus/instincts/personal/` (for universal patterns)
