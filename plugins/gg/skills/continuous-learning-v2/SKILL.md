...
| Feature | v2.0 | v2.1 |
|---------|------|------|
| Storage | Global (`~/.claude/homunculus/`) | Project-scoped (`${XDG_DATA_HOME:-~/.local/share}/gg-homunculus/projects/<hash>/`) |
...
Each project gets a 12-character hash ID (e.g., `a1b2c3d4e5f6`). A registry file at `${XDG_DATA_HOME:-~/.local/share}/gg-homunculus/projects.json` maps IDs to human-readable names.
...
For a full user-facing setup and operation guide, see [README.md](README.md).
...
```bash
# Global directories
mkdir -p "${XDG_DATA_HOME:-$HOME/.local/share}/gg-homunculus"/{instincts/{personal,inherited},evolved/{agents,skills,commands},projects}
...
```
${XDG_DATA_HOME:-~/.local/share}/gg-homunculus/
...
|-------------|-------|---------|
| Language/framework conventions | **project** | "Use table-driven Go tests", "Follow project API patterns" |
