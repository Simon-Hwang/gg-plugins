...
- [ ] Template engine auto-escaping enabled (Jinja2, Go html/template)
...
#### Lock Files
```bash
# Python — always commit lock files
git add requirements.txt uv.lock  # or poetry.lock, Pipfile.lock

# Go — always commit go.sum
git add go.sum
```

#### Verification Steps
- [ ] Dependencies up to date
- [ ] No known vulnerabilities (govulncheck / pip-audit clean)
