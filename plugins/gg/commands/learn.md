...
Analyze the current session for patterns worth preserving. Applies a quality gate, determines the correct save location, and writes a skill file only after user confirmation.
...
- `/gg:evolve` — promote clustered instincts into commands, skills, or agents
- `/gg:instinct-status` — view all learned instincts
- `/gg:checkpoint` — create a workflow checkpoint before/after extracting patterns
